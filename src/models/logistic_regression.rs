...
impl LogisticRegression {
    ...
    /// ## Returns
    /// `Self` - An instance of a logistic regression model
    ...
    /// Create a new logistic regression model by reading in a `.csv` file.
    /// ## Parameters
    ...
    pub fn predict(&self, x: Vector) -> Scalar {
        sigmoid(self.weights.clone() * x  + self.bias)
    }
...
impl Plotable for LogisticRegression {
